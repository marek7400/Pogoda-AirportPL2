...
*   **Czas odświeżania**: Dane są automatycznie sprawdzane i aktualizowane co **30 minut**, zgodnie z typowym cyklem publikacji depesz METAR. Aplikacja aktualizuje dane również natychmiast po uruchomieniu.
...
*   **Wybór lotniska**: 
    ...
    *   Możliwość wyboru spośród kilkudziesięciu polskich lotnisk pogrupowanych miastami (np. EPKK Kraków, EPWA Warszawa-Chopin, EPMO Modlin).
